...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------------------------ageIterator-----------------------------");
		Iterator<Customer> ageIterator = customerCollection.ageIterator();
		while (ageIterator.hasNext()) {
			System.out.println(ageIterator.next());
		}
		System.out.println("---------------------------cityFilterIterator-----------------------------");
		Predicate<Customer> cityPredicate = p -> p.getAddress().getCity().equals("Chicago");
		Iterator<Customer> cityFilterIterator = customerCollection.filterIterator(cityPredicate);
		while (cityFilterIterator.hasNext()) {
			System.out.println(cityFilterIterator.next());
		}
		System.out.println("---------------------------zipFilterIterator-----------------------------");
		...
		while (zipFilterIterator.hasNext()) {
			System.out.println(zipFilterIterator.next());
		}
		System.out.println("---------------------------StepOverIterator-----------------------------");
		Iterator<Customer> stepOverIterator = customerCollection.stepOverIterator();
		while (stepOverIterator.hasNext()) {
			System.out.println(stepOverIterator.next());
		}
